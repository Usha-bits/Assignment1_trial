...
# Encode the Categorical data of TransactionType - using Dummy Column - Creates a new column called TransactionType_M
# Use Dummy Variables
...
X = df.iloc[:,[0,1,2,3,4,5]]   #Age, Co_Morbid, Remdesevir_given, DaysofStay, Covid_Severity, Gender
